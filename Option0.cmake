# Option 0
# How GENIE is setup on `trunk` of ldmx-sw right now
# Somehow it works in ldmx-sw but it doesn't work here
...
if(NOT DEFINED GENIE_LIBRARIES)
  ...
  set(GENIE_LIBRARIES
     ...
     ROOT::MathCore
     ROOT::MathMore)
   message(STATUS "Found GENIE with Option 0")
endif()
